...
var _a, _b;
var IS_XHTML = ((_b = (_a = globalThis.document) == null ? void 0 : _a.contentType) == null ? void 0 : _b.includes("xml")) ?? false;
var ELEMENT_NODE = 1;
var TEXT_NODE = 3;
var COMMENT_NODE = 8;
    ...
    if (new_deps !== null) {
      ...
      if (effect_tracking() && (reaction.f & CONNECTED) !== 0) {
        for (i = skipped_deps; i < deps.length; i++) {
          ((_b2 = deps[i]).reactions ?? (_b2.reactions = [])).push(reaction);
        }
      }
...
function get(signal) {
  ...
  if ((_b2 = batch_values) == null ? void 0 : _b2.has(signal)) {
...
function first_child(node, is_text = false) {
  ...
  if (is_text) {
    if (((_a2 = hydrate_node) == null ? void 0 : _a2.nodeType) !== TEXT_NODE) {
      var text = create_text();
      (_b2 = hydrate_node) == null ? void 0 : _b2.before(text);
      set_hydrate_node(text);
      return text;
    }
    merge_text_nodes(
...
//# sourceMappingURL=chunk-N2D3RMHQ.js.map
